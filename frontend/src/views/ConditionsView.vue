<template>
	...
	<div class="container p-4">
		<div class="row">
			<div class="col-12 title">Conditions générales d’utilisation</div>
			<div class="col-12 paraf">
				En vigueur au 04/10/2022 Les présentes conditions générales
				d'utilisation (dites « CGU ») ont pour objet l'encadrement juridique des
				modalités de mise à disposition du site et des services par
				_______________ et de définir les conditions d’accès et d’utilisation
				des services par « l'Utilisateur ». Les présentes CGU sont accessibles
				sur le site à la rubrique «CGU». Toute inscription ou utilisation du
				site implique l'acceptation sans aucune réserve ni restriction des
				présentes CGU par l’utilisateur. Lors de l'inscription sur le site via
				le Formulaire d’inscription, chaque utilisateur accepte expressément les
				...
				healthy-farm.com se réserve le droit de modifier unilatéralement et à
				tout moment le contenu des présentes CGU.
			</div>
			<div class="col-12 paraf">
				<p class='sous-titre'>ARTICLE 1 : Les mentions légales</p>
				L’édition et la direction de la publication du site healthy-farm.com est
				assurée par jean, domicilié boldin. Numéro de téléphone est 0606252545
				Adresse e-mail jeanboldin@healthyfarm.com. L'hébergeur du site
				healthy-farm.com est la société healthyfarm, dont le siège social est
				situé au campagne, avec le numéro de téléphone : 0625062545.
			</div>
			<div class="col-12 paraf">
				<p class='sous-titre'>ARTICLE 2 : Accès au site</p>
				Le site healthy-farm.com permet à l'Utilisateur un accès gratuit aux
				services suivants : Le site internet propose les services suivants :
				Informations sur les poules : - rythme cardiaque - température -
				localisation Le site est accessible gratuitement en tout lieu à tout
				...
				connexion Internet, etc.) sont à sa charge. L’Utilisateur non membre n'a
				...
				doit ensuite s'identifier à l'aide de son identifiant et de son mot de
				passe qui lui seront communiqués après son inscription. Tout Utilisateur
				membre régulièrement inscrit pourra également solliciter sa
				désinscription en se rendant à la page dédiée sur son espace personnel.
				Celle-ci sera effective dans un délai raisonnable. Tout événement dû à
				un cas de force majeure ayant pour conséquence un dysfonctionnement du
				site ou serveur et sous réserve de toute interruption ou modification en
				cas de maintenance, n'engage pas la responsabilité de healthy-farm.com.
			...
			<div class="col-12 paraf">
				<p class='sous-titre'>ARTICLE 3 : Collecte des données</p>
			...
			<div class="col-12 paraf">
				<p class='sous-titre'>ARTICLE 4 : Propriété intellectuelle</p>
			...
			<div class="col-12 paraf">
				<p class='sous-titre'>ARTICLE 5 : Responsabilité</p>
				Les sources des informations diffusées sur le site healthy-farm.com sont
				...
				Malgré des mises à jour régulières, le site healthy-farm.com ne peut
				...
				toute responsabilité. Le site healthy-farm.com ne peut être tenu pour
				...
				l’accès, ou au téléchargement provenant de ce site. La responsabilité du
				site ne peut être engagée en cas de force majeure ou du fait
				imprévisible et insurmontable d'un tiers.
			</div>
			<div class="col-12 paraf">
				<p class='sous-titre'>ARTICLE 6 : Liens hypertextes</p>
				...
				healthy-farm.com. Ce dernier n’a pas de contrôle sur les pages web sur
				lesquelles aboutissent ces liens et ne saurait, en aucun cas, être
				responsable de leur contenu.
			</div>
			<div class="col-12 paraf">
				<p class='sous-titre'>ARTICLE 7 : Cookies</p>
				...
				nécessaires à l’utilisation du site healthy-farm.com. Les cookies ne
				...
				healthy-farm.com. En naviguant sur le site, L’Utilisateur les accepte.
			...
			<div class="col-12 paraf">
				<p class='sous-titre'>ARTICLE 8 : Droit applicable et juridiction compétente</p>
